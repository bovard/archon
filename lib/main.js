...
var argv = optimist.boolean(['a', 'b', 'e', 'g', 'h', 'l', 'm', 's', 't', 'v', 'x'])
        .alias({
            'a': 'local-branches',
            'b': 'remote-branches',
            'e': 'export-csv',
...
function _printMatchHelp() {
    console.log('Usage:');
    console.log('  archon match [maps] [teams] [-e/-l/-m/-o/-r/-s/-t');
    console.log('Example:');
...
function _runMatches() {
    ...
    runMatches(maps, teams, host, argv.s, argv.r, argv.e, argv.l, argv.x);
}
