    ...
    computeELOs: function(teams, series) {
        ...
        for (game in games) {
            if (teams.indexOf(game.teamA) !== -1 && teams.indexOf(game.teamB) !== -1) {
                ...
                teamELO[teamA] = elo.calculate_new_elo(aELO, bELO, game.winner === game.teamA);
                teamELO[teamB] = elo.calculate_new_elo(bELO, aELO, game.winner === game.teamB);
            }
        }
